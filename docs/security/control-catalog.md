...
|---|---|---|---|---|
| MCP-AUTH-001 | MCP + RFC9700 | Validate short-lived bearer tokens and audience | `proxy/http.py`, `security/token_validation.py` | planned |
...
| MCP-THREAT-001 | NIST CSF 2.0 | Apply threat intelligence rules during runtime decisions | `pipeline/inbound/threat_feed.py` | planned |
| MCP-ALERT-001 | NIST CSF 2.0 | Emit high-severity deny/redact events to responders | `alerts/engine.py` | planned |
